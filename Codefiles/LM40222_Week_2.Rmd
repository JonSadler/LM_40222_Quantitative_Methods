...
### Next Week
Next week you will be introduced to the ways in which you can use R to map geographical data sources. We be using ggplot2 as key resources but introducing you to other packages, such as **tmap**, **sf** and **terra** which will allow you to use R as a Geographical Information System (GIS).
...
3. Work through the following tutorial. **Pay particular attention to the code verbs (filter, arrange and mutate). You have used two of them already. Tutorial: https://rpubs.com/Sergio_Garcia/592172.
