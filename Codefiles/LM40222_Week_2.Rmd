...
![](/Users/jonsadler/Library/CloudStorage/OneDrive-UniversityofBirmingham/Teaching-materials/COURSES/4TH_YR/LM 40222 Quantitative methods/Images/gapminder_table.png) 
...
**HINT:** Use the code from our plot above to guide you (i.e. the one we called **BhamPlot**); you only need to change the dataframe name, variable names and alter the labels.

### Follow on work 

1. Read chapter 1 of <https://r4ds.hadley.nz/data-visualize> which we replicated with our plotting exercise today. 
2. Finish the class exercise if you didn't manage to do so in class.
